    ...
    >
      <motion.div variants={fadeLeft}>
        <Link
          ...
          className="group block relative w-full rounded-3xl overflow-hidden border border-black/10 dark:border-white/10 bg-black/5 dark:bg-zinc-900/50 hover:border-cyan-500/50 transition-colors duration-500"
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 p-8 md:p-12">
            <div className="flex-1 space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">
              ...
              <div className="flex items-center gap-2 text-cyan-600 dark:text-cyan-400 font-medium text-sm pt-4">
                View project
